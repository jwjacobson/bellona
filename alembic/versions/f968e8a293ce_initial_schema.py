...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["source_connector_id"], ["connectors.id"], ondelete="SET NULL"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_table(
        ...
        sa.Column("entity_type_id", sa.Uuid(), nullable=False),
        sa.Column(
            "mapping_config", postgresql.JSONB(astext_type=sa.Text()), nullable=False
        ),
        sa.Column("status", sa.String(length=20), nullable=False),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["source_entity_type_id"], ["entity_types.id"], ondelete="RESTRICT"
        ),
        sa.ForeignKeyConstraint(
            ["target_entity_type_id"], ["entity_types.id"], ondelete="RESTRICT"
        ),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint("name"),
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["relationship_type_id"], ["relationship_types.id"], ondelete="RESTRICT"
        ),
        sa.ForeignKeyConstraint(
